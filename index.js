...
/////////////////
const BotName = 'SHIZU BOT☄'; 
const instagram = 'https://instagram.com/rajaferbiansyahh'; 
const telegram = 'https://t.me/shizukana'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@rajaferbiansyahh')
